...
def restrictions_helper(meal):
    """
    tuple -> list
    Function creates a list of restrictions from data passed in about a recipe
    """
    restrictions = []
    if meal[10] == "Y":
...
def preloadRecipes():
    ...
    for Meal_Helper.py AddRecipe() function.
    """
    # Connect to database
    ...
    with open("~/project/Flask_app/recipePreload.json") as jsonFile:
        ...
        # Recipes are in list of dictionaries format
